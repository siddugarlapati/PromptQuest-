...
export default function World10() {
    ...
    return (
        <div className="container" style={{ paddingTop: 32, paddingBottom: 48 }}>
            <WorldHeader
                emoji="🏋️" title="World 10: Mini AI Trainer"
            ...
            {!showGame ? (
                <div className="fade-in">
                    <div className="glass-card" style={{ padding: 32, marginBottom: 24, borderLeft: '4px solid #16a34a' }}>
                        <h2 style={{ fontSize: '1.5rem', fontWeight: 800, color: '#16a34a', marginBottom: 16 }}>
                            How Do AIs Actually Learn?
                        </h2>
                        <p style={{ fontSize: '1rem', color: '#334155', lineHeight: 1.7, marginBottom: 16 }}>
                            AIs like ChatGPT aren't born knowing everything. They start as blank mathematical slates that must be <strong>trained</strong>.
                            Training an AI is remarkably similar to teaching a human toddler: you show it thousands of examples, correct it when it's wrong, and praise it when it's right.
                        </p>
                        <h3 style={{ fontSize: '1.2rem', fontWeight: 700, color: '#1A1A2E', marginTop: 24, marginBottom: 12 }}>
                            The Three Stages of Training
                        </h3>
                        <p style={{ fontSize: '1rem', color: '#334155', lineHeight: 1.7, marginBottom: 16 }}>
                            1. <strong>Pre-training (Reading the internet):</strong> The AI reads Wikipedia, Reddit, books, and code to learn the basic structure of human language. It's just predicting the next word.<br />
                            2. <strong>Supervised Fine-Tuning (SFT):</strong> Humans write high-quality Q&A examples to teach the AI how to be a helpful assistant instead of just a text-completer. <br />
                            3. <strong>Reinforcement Learning from Human Feedback (RLHF):</strong> Humans rate the AI's answers as "Good" or "Bad". The AI updates its internal math to generate more "Good" answers in the future!
                        </p>
                        ...
                        <div style={{ background: '#F8FAFC', padding: 20, borderRadius: 12, border: '1px solid #E2E8F0', marginTop: 24 }}>
                            ...
                            <p style={{ margin: 0, color: '#334155', lineHeight: 1.6, fontSize: '0.95rem' }}>
                                The magic of Machine Learning is <strong>generalization</strong>. If you teach an AI that a Dog is an Animal and a Cat is an Animal, a well-trained model will automatically deduce that an Elephant is an Animal—even if it has never seen the word "Elephant" during training.
                            </p>
                        </div>
                    </div>

                    <button className="btn btn-primary btn-lg" style={{ width: '100%', fontSize: '1.1rem', padding: 18, background: '#16a34a', color: 'white', border: 'none' }} onClick={() => setShowGame(true)}>
                        Let's Play: AI Training Lab 🚀
                    </button>
                </div>
            ) : (
                <div className="fade-in">
